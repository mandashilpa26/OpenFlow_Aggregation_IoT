...
protected:
    ...
    virtual OFP_Flow_Mod * createFlowMod(bool aggregateValue,ofp_flow_mod_command mod_com,const oxm_basic_match &match, uint32_t outport,int idleTimeOut, int hardTimeOut);
    ...
    virtual void sendFlowModMessage(bool aggregateValue,ofp_flow_mod_command mod_com,const oxm_basic_match &match, uint32_t outport, TCPSocket *socket,int idleTimeOut, int hardTimeOut);

...
class Flow_Table_Entry {
    public:
        ...
        //Aggregate
        double getAggregateTimeout() const;
        SimTime getAggregateExpiresAt() const;
        ...
        // Aggregate
        void setAggregateTimeout(double aggregateTimeout);
        void setAggregateExpiresAt(SimTime aggregateExpiresAt);
    ...
    protected:
        ...
        // Aggregate
        double aggregateTimeout;
        SimTime aggregateExpiresAt;
};
